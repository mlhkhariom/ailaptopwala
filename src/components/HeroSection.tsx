  ...
  >
    ...
    <div className="relative z-10 container mx-auto px-5 text-center max-w-4xl pt-20 pb-10">
      ...
      <motion.h1
        ...
        className="font-heading text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black leading-[1.1] mb-5 tracking-tight"
      >
        Welcome to{" "}
      ...
      <motion.p
        ...
        className="text-base sm:text-lg md:text-xl text-foreground/80 font-medium mb-3 max-w-2xl mx-auto leading-relaxed"
      >
      ...
      >
        ...
        <a
          ...
          className="w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-2xl border-2 border-primary/40 px-8 py-3.5 text-base font-bold text-primary hover:bg-primary/10 transition-all active:scale-95"
        >
