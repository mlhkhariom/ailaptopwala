  ...
  return (
    <div className="p-4 md:p-8 space-y-6 md:space-y-8 animate-fade-in">
      ...
      <div className="flex flex-col md:flex-row items-start md:items-end justify-between">
        ...
        <div className="hidden sm:flex items-center gap-2 px-4 py-2 rounded-full bg-success/10 border border-success/20 mt-4 md:mt-0">
      ...
      <div>
        <h2 className="text-xl md:text-2xl font-bold mb-4 md:mb-6">Chat Analytics</h2>
        <DashboardStats />
      </div>
      ...
      <div className="glass-card p-6">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 md:gap-0">
          <div className="flex flex-col sm:flex-row items-center gap-6 sm:gap-8 text-center sm:text-left">
            ...
            <div className="w-10 h-px sm:w-px sm:h-10 bg-border" />
            <div>
