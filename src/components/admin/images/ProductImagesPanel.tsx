...
export function ProductImagesPanel() {
  ...
  const handleDelete = async (public_id: string, name: string) => {
    try {
      const response = await fetch(`${API_BASE_URL}/cloudinary-upload`, {
        ...
        body: JSON.stringify({ action: 'delete', public_id }),
      });
  ...
  return (
    <div className="h-full flex flex-col p-3 sm:p-4 md:p-6 space-y-4 md:space-y-6 overflow-auto">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
        ...
        <Card className="glass-card border-border/50 p-3 sm:p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-lg sm:text-2xl font-bold">10MB</p>
        ...
        <Card className="glass-card border-border/50 p-3 sm:p-4 col-span-2 sm:col-span-1">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-lg sm:text-2xl font-bold">Multi</p>
            ...
            {uploading ? (
              <div className="flex flex-col items-center gap-3">
                ...
                <p className="text-sm text-muted-foreground">
                  Uploading to Cloudinary... {uploadProgress.total > 0 && `(${uploadProgress.current}/${uploadProgress.total})`}
                </p>
              </div>
            ) : (
              <div className="flex flex-col items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">or click to browse (JPG/PNG/WebP, max 10MB each)</p>
                </div>
              </div>
            )}
          </div>
      ...
      {/* Image Gallery */}
      <Card className="glass-card border-border/50 flex-1 min-h-0 flex flex-col">
        ...
        <CardContent className="px-4 sm:px-6 flex-1 min-h-0">
