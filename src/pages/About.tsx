...
const aboutSchema = {
  ...
  "description": "About AI Laptop Wala (Asati Infotech) - Best laptop shop in Indore, Madhya Pradesh. Founded by Bhagwan Das Asati in 2011.",
  "mainEntity": {
    "@type": "ComputerStore",
    "name": "AI Laptop Wala",
...
const About = () => (
  <div className="pt-20">
    <SEOHead
      title="About AI Laptop Wala Indore – Asati Infotech | Best Laptop Shop Since 2011"
      description="Learn about AI Laptop Wala (Asati Infotech) – Indore's trusted laptop shop since 2011. Founded by Bhagwan Das Asati, managed by Nitin Asati. 5000+ happy customers. Premium MacBooks, gaming laptops, refurbished systems. Silver Mall, RNT Marg, Indore, Madhya Pradesh."
      canonical="/about"
    ...
    <section className="bg-gradient-to-br from-foreground to-foreground/90 text-background py-16 md:py-24">
      <div className="container mx-auto px-5 text-center max-w-3xl">
        ...
        <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.2 }} className="text-background/60 text-sm md:text-base">
          Powered by Asati Infotech — Your trusted tech partner since 2011
        </motion.p>
      </div>
    </section>
      ...
      <div className="container mx-auto px-5 max-w-3xl">
        <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="glass-card-solid glow-cyan gradient-border p-6 md:p-10 rounded-2xl">
          <p className="text-muted-foreground leading-relaxed text-sm md:text-base mb-5">
            Founded by <strong className="text-foreground">Mr. Bhagwan Das Asati</strong> in 2011, <strong className="text-foreground">Asati Infotech</strong> has become a household name in Indore's tech market under the brand <span className="text-primary font-semibold">AI Laptop Wala</span>.
          </p>
          <p className="text-muted-foreground leading-relaxed text-sm md:text-base mb-5">
